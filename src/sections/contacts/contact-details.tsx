...
import { ContactDetailsTickets } from './details/contact-details-tickets';
    ...
    <Grid container spacing={3} sx={{ my: 1 }}>
            ...
            {currentUser && (
              <>
                ...
                <Stack spacing={2} sx={{ p: 3, typography: 'body2' }}>
                  {/* <Box sx={{ display: 'flex' }}>
                    <Iconify width="var(--icon-size-base)" icon="ic:round-person" sx={{ mr: 2 }} />
                    {currentUser?.name}
                  </Box> */}
      ...
      <Grid size={{ xs: 12, md: 8 }}>
        ...
        <Card sx={{ my: 2, maxHeight: 'calc(100vh - 275px)', overflowY: 'auto' }}>
          {selectedTab === '' && <ContactDetailsTickets />}
          {/* {selectedTab === 'Activities' && <ContactDeatilsActivities />}
          {selectedTab === 'notes' && <ContactDeatilsNotes />}
          {selectedTab === 'calls' && <ContactDeatilsCalls />}
          {selectedTab === 'email' && <ContactDeatilsEmail />}
          {selectedTab === 'whatsapp' && <ContactDeatilsWhatsppp />} */}
        </Card>
      </Grid>
    </Grid>
  );
