...
import { AccountDetailsTickets } from './account-details-tickets';
import { AccountDetailsContactList } from './account-details-contact-list';
    ...
    <Grid container spacing={3} sx={{ my: 1 }}>
      ...
      <Grid size={{ xs: 12, md: 9 }}>
        ...
        <Card sx={{ my: 2, maxHeight: 'calc(100vh - 275px)', overflowY: 'auto' }}>
          {selectedTab === '' && <AccountDetailsTickets />}
          {selectedTab === 'contact_list' && <AccountDetailsContactList />}
        </Card>
      </Grid>
    </Grid>
  );
