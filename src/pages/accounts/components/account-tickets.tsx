...
import { ContactTicketsTableRow } from './account-tickets.row';
import { ContactTicketsTableHeader } from './account-tickets-header';
              ...
              {dataFiltered
                ...
                .map((row) => (
                  <ContactTicketsTableRow
                    ...
                    editHref={paths.contact.details(row.id)}
                  />
                ))}
